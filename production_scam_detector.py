...
class ProductionScamDetector:
    ...
    def __init__(self):
        """Initialize all three detection stages."""
        ...
        try:
            ...
            print(f"❌ Stage 3 unavailable: {e}")
            raise RuntimeError("Stage 3 (type classifier) is required!")
    ...
    def detect(self, message):
        """
        Production detection with tiered confidence.
        ...
        # Stage 2: Indian Model (defensive catch)
        ...
        # Both stages said not scam → Legitimate
